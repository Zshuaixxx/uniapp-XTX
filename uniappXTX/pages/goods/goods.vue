...
const getGoodsDetail= async() => {
	const res=await getGoodsDetailService(query.id)
...
<template>
  <scroll-view scroll-y="true" class="viewport" scroll="y">
    <!-- 基本信息 -->
    <view class="goods">
      <!-- 商品主图 -->
      <view class="preview">
        ...
        <view class="indicator">
          <text class="current">{{nowpic}}</text>
    ...
    <view class="detail panel">
      ...
      <view class="content">
        <view class="properties">
          <!-- 属性详情 -->
          <view class="item"
		   v-for="item in goodsDetail.details.properties" :key="item.name" >
        ...
        <image
          mode="widthFix"
          v-for="item in goodsDetail.details.pictures" :key="item"
		  :src="item"
        ></image>
      </view>
    </view>
