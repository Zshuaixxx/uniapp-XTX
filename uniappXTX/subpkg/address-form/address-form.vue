  ...
  <view class="content">
    <form>
      ...
      <view class="form-item">
        ...
        <picker class="picker" mode="region" :value="form.fullLocation.split(' ')" @change="newLocal">
      ...
      <view class="form-item">
        ...
        <switch class="switch" color="#27ba9b" :checked="form.isDefault === 1"  @change="newDefault"/>
      </view>
    </form>
  </view>
  <!-- 提交按钮 -->
  <button class="button" @tap="baocundizhi">保存并使用</button>
</template>
